  ...
  return (
    <GuideShell>
      ...
      <section className="article-section"><div className="shell article-grid">
        <aside className="article-toc"><strong>FIELD GUIDE</strong><a href="#confirmed">Confirmed signs</a><a href="#head-banger">Head Banger</a><a href="#not-signs">Not enough alone</a><a href="#groups">Groups</a><a href="#reject">Reject controls</a><a href="#uncertain">When uncertain</a></aside>
        <article className="article-body">
          ...
          <section id="head-banger"><h2>Head Banger response</h2><p>The official Roblox badge <strong>Keep Their Head Clear</strong> documents one named response: feed a Head Banger coffee. Exact spawn timing and visual cue can change during Alpha, so treat coffee as the verified response once you recognize that anomaly—not as a guess for every unusual guest.</p></section>
